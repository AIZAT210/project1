...
var IndexDisplayKeyEventHandler = /** @class */ (function () {
    function IndexDisplayKeyEventHandler() {
        // Bind 'this' to the handleKeyDown method to ensure correct context
        this.handleKeyDown = this.handleKeyDown.bind(this);
    }
    // Method to handle key down events
    IndexDisplayKeyEventHandler.prototype.handleKeyDown = function (e) {
    ...
    return IndexDisplayKeyEventHandler;
}());
// Instantiate KeyEventHandler and attach event listener for key down events
var IndexDisplaykeyEventHandler = new IndexDisplayKeyEventHandler();
document.addEventListener("keydown", IndexDisplaykeyEventHandler.handleKeyDown);
// Define a class for managing the copyright year
var IndexDisplayCopyrightYear = /** @class */ (function () {
    // Constructor to initialize start year and current year
    function IndexDisplayCopyrightYear(startYear) {
        this.startYear = startYear;
        this.currentYear = new Date().getFullYear();
    }
    // Method to generate the copyright year range
    IndexDisplayCopyrightYear.prototype.generateYearRange = function () {
    ...
    IndexDisplayCopyrightYear.prototype.updateHtmlContent = function (elementId) {
