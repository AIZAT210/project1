...
class IndexDisplayKeyEventHandler {
    constructor() {
...
const IndexDisplaykeyEventHandler = new IndexDisplayKeyEventHandler();
...
class IndexDisplayCopyrightYear {
    startYear: number;
    currentYear: number;
...
const IndexDisplaycopyright = new IndexDisplayCopyrightYear(2025);
