...
class SurahDisplayKeyEventHandler {
    constructor() {
...
const SurahDisplaykeyEventHandler = new SurahDisplayKeyEventHandler();
...
class SurahDisplayCopyrightYear {
    startYear: number;
    currentYear: number;
...
const SurahDisplaycopyright = new SurahDisplayCopyrightYear(2025);
