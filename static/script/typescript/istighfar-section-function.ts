...
class IstighfarDisplayKeyEventHandler {
    constructor() {
...
const IstighfarDisplaykeyEventHandler = new IstighfarDisplayKeyEventHandler();
...
class IstighfarDisplayCopyrightYear {
    startYear: number;
    currentYear: number;
...
const IstighfarDisplaycopyright = new IstighfarDisplayCopyrightYear(2025);
