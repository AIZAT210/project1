...
class SelawatDisplayKeyEventHandler {
    constructor() {
...
const SelawatDisplaykeyEventHandler = new SelawatDisplayKeyEventHandler();
...
class SelawatDisplayCopyrightYear {
    startYear: number;
    currentYear: number;
...
const SelawatDisplaycopyright = new SelawatDisplayCopyrightYear(2025);
