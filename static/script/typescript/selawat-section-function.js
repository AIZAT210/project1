...
var SelawatDisplayKeyEventHandler = /** @class */ (function () {
    function SelawatDisplayKeyEventHandler() {
        // Bind 'this' to the handleKeyDown method to ensure correct context
        this.handleKeyDown = this.handleKeyDown.bind(this);
    }
    // Method to handle key down events
    SelawatDisplayKeyEventHandler.prototype.handleKeyDown = function (e) {
    ...
    return SelawatDisplayKeyEventHandler;
}());
// Instantiate KeyEventHandler and attach event listener for key down events
var SelawatDisplaykeyEventHandler = new SelawatDisplayKeyEventHandler();
document.addEventListener("keydown", SelawatDisplaykeyEventHandler.handleKeyDown);
// Define a class for managing the copyright year
var SelawatDisplayCopyrightYear = /** @class */ (function () {
    // Constructor to initialize start year and current year
    function SelawatDisplayCopyrightYear(startYear) {
        this.startYear = startYear;
        this.currentYear = new Date().getFullYear();
    }
    // Method to generate the copyright year range
    SelawatDisplayCopyrightYear.prototype.generateYearRange = function () {
    ...
    SelawatDisplayCopyrightYear.prototype.updateHtmlContent = function (elementId) {
